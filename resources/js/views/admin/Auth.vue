        ...
        <div class="options-tabs">
            <FormWrapper>
                <form>
                    ...
                    <!-- enable SSO -->
                    <FormCheckbox v-model="appSettings.enableSso" @update:model-value="val => useAppSettingsUpdater('enableSso', val)" fieldName="enableSso" label="field.enable_sso" help="field.enable_sso.help" />
                        <!-- use SSO only -->
                        <FormCheckbox v-model="appSettings.useSsoOnly" @update:model-value="val => useAppSettingsUpdater('useSsoOnly', val)" fieldName="useSsoOnly" label="field.use_sso_only" help="field.use_sso_only.help" :isDisabled="!appSettings.enableSso" :isIndented="true" />
                        <!-- Allow Pat In SSO Only -->
                        <FormCheckbox v-model="appSettings.allowPatWhileSsoOnly" @update:model-value="val => useAppSettingsUpdater('allowPatWhileSsoOnly', val)" fieldName="allowPatWhileSsoOnly" label="field.allow_pat_in_sso_only" help="field.allow_pat_in_sso_only.help" :isDisabled="!appSettings.useSsoOnly" :isIndented="true" />
                    <h4 class="title is-4 pt-4 has-text-grey-light">{{ $t('heading.registrations') }}</h4>
                    <!-- restrict registration -->
                    <FormCheckbox v-model="appSettings.restrictRegistration" @update:model-value="val => useAppSettingsUpdater('restrictRegistration', val)" fieldName="restrictRegistration" :isDisabled="appSettings.disableRegistration" label="field.restrict_registration" help="field.restrict_registration.help" />
                        <!-- restrict list -->
                    ...
                    <FormCheckbox v-model="appSettings.disableRegistration" @update:model-value="val => useAppSettingsUpdater('disableRegistration', val)" fieldName="disableRegistration" label="field.disable_registration" help="field.disable_registration.help" />
