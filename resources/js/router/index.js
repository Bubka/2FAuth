...
import skipIfSharingDisabled from './middlewares/skipIfSharingDisabled'
...
const router = createRouter({
	...
	routes: [
        ...
        { path: '/account/:twofaccountId/sharing', name: 'accountSharing', component: () => import('../views/sharing/AccountSharing.vue'), meta: { middlewares: [authGuard, skipIfSharingDisabled, ownerOnly, setReturnTo], watchedByKicker: true }, props: true },
        { path: '/account/:twofaccountId/share', name: 'shareAccount', component: () => import('../views/sharing/Share.vue'), meta: { middlewares: [authGuard, skipIfSharingDisabled, ownerOnly], watchedByKicker: true }, props: true },
        { path: '/account/:twofaccountId/transfer', name: 'transferOwnership', component: () => import('../views/sharing/TransferOwnership.vue'), meta: { middlewares: [authGuard, skipIfSharingDisabled, ownerOnly], watchedByKicker: true }, props: true },
