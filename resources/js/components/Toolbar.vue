    ...
    <div class="toolbar has-text-centered">
        <div class="columns">
            <div class="column has-nowrap px-0">
                ...
                <!-- deselect all -->
                <button type="button" id="btnUnselectAll" @click="$emit('clear-selected')" class="clear-selection delete mr-4" :style="{visibility: selectedCount > 0 ? 'visible' : 'hidden'}" :title="$t('tooltip.clear_selection')"></button>
                <!-- select all button -->
