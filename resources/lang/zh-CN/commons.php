...
return [
    ...
    */
    ...
    'environment' => '环境变量',
    'credits' => '鸣谢',
    '2fauth_teaser' => '本网页 App 可助您管理两步验证 (2FA) 账号，并生成对应的验证码',
    'made_with' => '基于',
    'ui_icons_by' => 'UI 图标来自',
    'logos_by' => 'Logo 来自',
    'search' => '搜索​​​​',
    ...
    'check_for_update_help' => '自动检查更新 (每周一次)。当发现 2FAuth 有新版本时，会发出更新提醒',
    'you_are_up_to_date' => '已是最新版',
    '2fauth_description' => '此网页 App 可助您管理两步验证 (2FA) 账号，并生成对应的验证码',
