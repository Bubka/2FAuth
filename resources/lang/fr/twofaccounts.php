...
return [
    ...
    */
    ...
    'shared_account_indicator' => 'Compte partagé',
    ...
    'forms' => [
        ...
        'is_shared' => [
            'label' => 'Partager ce compte avec tous les utilisateurs',
            'help' => 'Lorsque activé, ce compte sera visible par tous les utilisateurs du système'
        ],
