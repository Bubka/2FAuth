...
WebAuthn 允许您使用受信任的设备 (如 Yubikeys 或具有生物识别功能的智能手机) 来安全、快捷地进行登录验证。',
        'use_security_device_to_sign_in' => '若要使用您的某个安全设备进行身份验证，请插入您的密钥设备，并摘下口罩或手套。',
        ...
        'disable_all_security_devices_help' => '将吊销您所有的安全设备。若某个设备已遗失或不再安全，请点击此选项。',
        ...
        'use_webauthn_only' => [
            ...
            'help' => '将 WebAuthn 设为 2FAuth 的唯一鉴权方式。若要发挥 WebAuth 的最佳安全性，推荐启用此选项。<br /><br />
                ...
                请注意！ 此选项启用后仍会显示邮箱和密码的登录界面，但尝试登录时永远会提示 “身份验证失败”。'
        ],
    ...
    'forms' => [
        ...
        'welcome_to_testing_app_use_those_credentials' => '欢迎来到 2FAuth 的测试实例。<br><br>您可以使用邮箱 <strong>testing@2fauth.app</strong> 和密码 <strong>password</strong> 来登录。',
