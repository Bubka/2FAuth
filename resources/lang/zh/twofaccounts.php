...
return [
    ...
    */
    ...
    'import' => [
        ...
        'import_legend_afterpart' => '使用这些应用的导出功能来获取迁移资源，例如二维码或JSON文件，然后加载它。',
        'upload' => '上传',
        'scan' => '扫描',
        ...
        'submitted_data_parsed_now_accounts_are_awaiting_import' => '在迁移资源中找到了以下2FA账户。到目前为止，它们都没有被添加到2FAuth中。',
