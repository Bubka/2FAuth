...
namespace App\Facades {
     ...
     */        class QrCode {
        ...
        {
                        return \App\Services\QrCodeService::encode($data);
        }
                    /**
        ...
        {
                        return \App\Services\QrCodeService::decode($file);
        }
            }
            /**
     * 
     ...
     */        class Groups {
         ...
         * @param \App\Models\User $user The user who owns the accounts & the target group
         * @param mixed $targetGroup The group the accounts should be assigned to
         * @throws \Illuminate\Auth\Access\AuthorizationException
         * @static 
         */        public static function assign($ids, $user, $targetGroup = null)
        {
                        return \App\Services\GroupService::assign($ids, $user, $targetGroup);
        }
                    /**
         ...
         * @param \Illuminate\Database\Eloquent\Collection<int, Group> $groups
         * @static 
         */        public static function setUser($groups, $user)
        {
                        return \App\Services\GroupService::setUser($groups, $user);
        }
            }
            /**
     * 
     ...
     */        class TwoFAccounts {
         ...
         * @static 
         */        public static function withdraw($ids)
        {
                        return \App\Services\TwoFAccountService::withdraw($ids);
        }
                    /**
         ...
         * @static 
         */        public static function migrate($migrationPayload)
        {
                        /** @var \App\Services\TwoFAccountService $instance */
                        return $instance->migrate($migrationPayload);
        }
                    /**
        ...
        {
                        return \App\Services\TwoFAccountService::export($ids);
        }
                    /**
        ...
        {
                        return \App\Services\TwoFAccountService::delete($ids);
        }
                    /**
         ...
         * @static 
         */        public static function setUser($twofaccounts, $user)
        {
