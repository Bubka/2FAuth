...
#[CoversClass(TwoFAccountShareRevokedNotification::class)]
class TwoFAccountShareRevokedNotificationTest extends FeatureTestCase
{
    #[Test]
    public function test_it_renders_to_email() : void
    {
        ...
        $notification = new TwoFAccountShareRevokedNotification($twofaccount, $owner->name, false);
    ...
    public function test_rendered_email_contains_expected_data() : void
    {
        ...
        $notification = new TwoFAccountShareRevokedNotification($twofaccount, $owner->name, true);
